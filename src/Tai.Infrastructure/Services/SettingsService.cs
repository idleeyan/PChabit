...
public class SettingsService : ISettingsService
{
    ...
    {
        var appDataPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Tai");
    ...
    private static void CreateShortcut(string shortcutPath, string targetPath)
    {
        ...
        try
        {
            ...
            shortcutType.InvokeMember("Description", System.Reflection.BindingFlags.SetProperty, null, shortcut, new object[] { "Tai Activity Tracker" });
